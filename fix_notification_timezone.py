...
def main():
    ...
    try:
        ...
        execute_query(cursor, """
        UPDATE notification
        SET expiry_date = expiry_date AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Shanghai'
        ...
        """, description="检查通知已读表是否存在")
        
        # 3. 修复通知已读表中的时间字段
        execute_query(cursor, """
        UPDATE notification_read
        SET read_at = read_at AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Shanghai'
