...
def main():
    ...
    try:
        ...
        # 询问用户是否要继续
        answer = input("\n您看到了当前的通知时间。您想要将第一条通知的时间设置为UTC时间 2025-06-25 12:32:10 吗? (y/n): ")
        
        if answer.lower() != 'y':
            print("操作已取消")
            return 0
        
        # 直接设置通知时间为正确的UTC时间（对应北京时间2025-06-25 20:32:10）
        execute_query(cursor, """
        UPDATE notification
        SET created_at = '2025-06-25 12:32:10'::timestamp
        WHERE id = 1;
