...
def deploy_to_render():
    ...
    try:
        ...
        # 添加修改的文件
        logger.info("添加修改的文件...")
        run_command("git add src/routes/education.py", cwd=current_dir)
        
        # 提交修改
        commit_message = f"修复教育资源页面500错误 - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
