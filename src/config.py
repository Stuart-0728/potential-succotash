...
class Config:
    ...
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD')  # 对于QQ邮箱，这里是授权码
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', MAIL_USERNAME)
    MAIL_MAX_EMAILS = int(os.environ.get('MAIL_MAX_EMAILS', 20))
    MAIL_SUBJECT_PREFIX = os.environ.get('MAIL_SUBJECT_PREFIX', '[重庆师范大学师能素质协会] ')
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or \
        f'sqlite:///{os.path.join(INSTANCE_PATH, "cqnu_association.db")}'
